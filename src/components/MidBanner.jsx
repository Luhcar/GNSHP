        ...
        <div className="absolute inset-0 bg-black/60 md:rounded-2xl opacity-90 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4">
              Crafting Confidence Through the Best in Fashion
            </h1>
            <p className="text-lg md:text-xl mb-6">
              Discover a world of style and comfort at our online store. Shop
              now and elevate your wardrobe with our exceptional selection of
