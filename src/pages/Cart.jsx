...
const Cart = ({ location, getLocation }) => {
  ...
  return (
    <div className="mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0">
      {cartItems.length > 0 ? (
        <div>
          <h1 className="font-bold text-2xl">My Cart ({cartItems.quantity})</h1>
          <div>
            <div className="mt-10">
              {cartItems.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="bg-red-500 text-white flex gap-4 p-2 rounded-md font-bold md:text-xl">
                      <button
                        onClick={() =>
                          updateQuantity(cartItems, item.id, "decrement")
                        }
                      ...
                      <button
                        onClick={() =>
                          updateQuantity(cartItems, item.id, "increment")
                        }
                        className="cursor-pointer"
                      >
                        +
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20">
              <div className="bg-gray-100 rounded-md space-y-2 p-7 mt-4">
              ...
              <div className="bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max">
                ...
                <div className="flex justify-between items-center ">
                  <h1 className="flex gap-1 items-center text-gray-7000">
                    {" "}
                    <span>
                      <LuNotebookText />
                    </span>
        ...
        <div className="flex flex-col gap-3 justify-center items-center h-[600px]">
          <h3 className="text-red-500/80 font-bold text-5xl text-muted">
